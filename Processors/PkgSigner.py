...
# https://github.com/autopkg/rtrouton-recipes/blob/master/SharedProcessors/PkgSigner.py
...
class PkgSigner(Processor):
    ...
    def main(self):
        ...
        # Delete the unsigned package
        if os.path.exists(unsigned_pkg_path):
            os.remove(unsigned_pkg_path)
            print(f"Deleted unsigned package: {unsigned_pkg_path}")
